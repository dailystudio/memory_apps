...
function createInstructions() {
	...
	text.innerHTML = '<span style="color:' + theme[0] + ';font-size:40px;">Oops!</span><br /><span style="font-size:15px;"><strong>Page not found:</strong><br /><br />&nbsp;Click&nbsp;on&nbsp;this&nbsp;ball<br/> to retry.<br /></span>';
...
function retryHome() {
	homeUrl = webHomeConfiguration.getWebHomePageUrl();
	console.log("retry Home Url: " + homeUrl);
	window.open(homeUrl);	
}
